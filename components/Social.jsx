...
import { RiYoutubeFill, RiInstagramFill, RiFacebookFill, RiLinkedinFill, RiGithubFill } from 'react-icons/ri';
  ...
  return (
    <div className='mt-10'>
      <div className='flex justify-center md:justify-start gap-x-4'>
        ...
        return (
          <Link target='_blank' key={index} href={link.path} className={iconsStyle}>
            {link.icon}
          </Link>
        );
      })} 
